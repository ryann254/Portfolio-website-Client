...
function Index() {
    ...
    const renderTooltip = (props) => (
        <Tooltip id="button-tooltip" {...props}>
          Click to add a News Article
        </Tooltip>
      );

    function handleDelete() {
        setModalShow(!modalShow)
        setModalType('delete news article')
        setTitle('Are you sure you want to delete this news article?')
        if (Id !== '') {
            setNewsBody(Id)
        }
    }
    ...
    function handleCreate() {
        setModalShow(!modalShow)
        setModalType('create news article')
        setTitle('Create an News Article')
    }
    ...
    return (
        <ContainerFrame>
            <Modal show={modalShow} modalType={modalType} title={title} body={newsBody} onHide={() => setModalShow(false)}/>
                            ...
                            <Overlay 
                                ...
                                <Col>
                                    <Event className="event">
                                        ...
                                        <EventHeader className="pt-4 pl-4 pr-4 pb-5">{newsItem.title}</EventHeader>
